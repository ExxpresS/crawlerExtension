...
class JsonFormatter {
    async format(workflowData, options) {
        ...
        // Extraire les éléments de layout communs à tous les states
        ...
        if (layoutElements.length > 0) {
            formatted.workflow.layout = layoutElements;
        }

        // Remplacer les states avec les versions nettoyées
        formatted.states = cleanedStates;
    ...
    getElementFingerprint(element) {
        // Utiliser plusieurs stratégies pour créer un fingerprint unique et stable
